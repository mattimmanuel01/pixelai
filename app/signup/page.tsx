      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center p-4">
        <div className="w-full max-w-lg text-center space-y-8">
          <div className="space-y-4">
            <div className="w-20 h-20 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full flex items-center justify-center mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-emerald-100">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-600">
                ...
                <span>Start using PixelAI Pro features!</span>
              </div>
            </div>
          ...
          {featureInfo ? (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h2 className="text-3xl font-bold leading-tight">
                  Unlock professional<br />AI features
                </h2>
                <p className="text-blue-100 text-lg">
                  Create your free account and start enhancing images with cutting-edge AI technology.
                </p>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
              <h2 className="text-4xl font-bold leading-tight">
                Join the PixelAI<br />community
              </h2>
              <p className="text-blue-100 text-lg">
                Start your creative journey with professional AI image tools.
              </p>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              {featureInfo ? 'Get started with Pro' : 'Create your account'}
            </h1>
            <p className="text-gray-600">
              {featureInfo ? 'Sign up to unlock AI features' : 'Join thousands of creators using PixelAI'}
            </p>
          </div>
